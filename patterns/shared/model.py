...
class TransformerBlock(nn.Module):
    def __init__(self, d_model: int, d_mlp: int, d_head: int, num_heads: int, num_ctx: int, act_fn: Callable = F.relu):
        super().__init__()
...
class Transformer(nn.Module):
    def __init__(self, num_layers: int, d_vocab: int, d_model: int, d_mlp: int, d_head: int, num_heads: int, num_ctx: int, act_fn: Callable = F.relu, use_ln: bool=True):
        super().__init__()
